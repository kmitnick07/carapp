...
class SharedPref {
  ...
  static String isMSLogin = 'msLogIn';
  static String adminEmail = 'adminEmail';
  static String adminPassword = 'adminPassword';
  static String sessionLogout = 'sessionLogout';
  static String updatenotnow = 'updatenotnow';
  static String offlineDropdownDataList = 'offlinedropdowndatalist';
  static String offlineTenantDataList = 'offlinetenantdatalist';
  static String offlineFieldDataList = 'offlinefielddatalist';
  static String hasShownGreeting = 'hasShownGreeting';
}
...
class Settings {
  ...
  Future _init() async {
    ...
    // if (kIsWeb &&
    //     (isUserLogin && DateTime.now().difference(logoutTime) > Duration(minutes: Config.sessionTimeOutMinutes))) {
    //   preferences?.clear();
    // }
  }
  ...
  static DateTime get logoutTime =>
      DateTime.parse(getLocalString(SharedPref.sessionLogout) ?? DateTime.now().toIso8601String());
  ...
  //     LoginDataModel.fromJson(jsonDecode(getLocalString(SharedPref.loginData) ?? '{}'));
  //
  ...
  static bool get hasShownGreeting => getLocalBool(SharedPref.hasShownGreeting) ?? false;

  static set hasShownGreeting(bool value) => setLocalBool(SharedPref.hasShownGreeting, value);
  ...
  static set offlineDropdownDataList(Map value) =>
      setLocalString(SharedPref.offlineDropdownDataList, jsonEncode(value));
  ...
  static set offlineTenantDataList(List value) =>
      setLocalString(SharedPref.offlineTenantDataList, jsonEncode({"data": value}));

...
//                 width: 30,
//                 decoration:
//                     BoxDecoration(borderRadius: BorderRadius.circular(6), color: ColorTheme.kGrey.withOpacity(0.25)),
//                 child: IconButton(
//                   onPressed: () {
//                     _controller.reverse();
//                     Future.delayed(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.only(
                                  ...
                                  bottomLeft: buttonCount == 1 ? const Radius.circular(16) : Radius.zero,
                                ),
                              ),
                              child: SizedBox(
                                height: 50,
